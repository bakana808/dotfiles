...
Singleton {
    ...
    rounding: QtObject {
        ...
        property int screenRounding: verysmall
    ...
    font: QtObject {
        property QtObject family: QtObject {
            ...
            property string main: "Inter Variable"
            property string title: "Inter Variable"
    ...
    fonts: QtObject {
        // Font used in bars and similar UI elements
        readonly property font bar: ({
                family: root.font.family.main,
                styleName: "SemiBold",
                pixelSize: root.font.pixelSize.normal,
                kerning: true,
                preferShaping: true,
                hinting: Font.PreferDeHinting
            })
        readonly property font workspace: ({
