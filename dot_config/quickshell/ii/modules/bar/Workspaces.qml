...
Item {
    ...
    property bool showNumbers: Config.options?.bar.workspaces.alwaysShowNumbers || false
    property bool showAppIcons: Config.options?.bar.workspaces.showAppIcons || false

    // color of dot for current workspace
    property string currentColor: ColorPalette.fg
    // color of text for current workspace
    property string currentColorFg: ColorPalette.bg

    // color of dots for inactive non-empty workspaces
    property string inactiveColor: ColorPalette.c8
    // color of text for inactive non-empty workspaces
    property string inactiveColorFg: ColorPalette.fg

    // color of dots/numbers for empty workspaces (small dots)
    property string emptyColorFg: ColorPalette.c8
    ...
    function isWorkspaceActive(index) {
        const wsId = workspaceGroup * Config.options.bar.workspaces.shown + index;
            ...
            Button {
                ...
                background: Item {
                    ...
                    StyledText {
                        ...
                        font: Appearance.fonts.workspace
                        text: Config.options?.bar.workspaces.numberMap[button.workspaceValue - 1] || button.workspaceValue
                        elide: Text.ElideRight
                        color: (root.monitor?.activeWorkspace?.id == button.workspaceValue) ? root.currentColorFg : (workspaceOccupied[index] ? root.inactiveColorFg : root.emptyColorFg)
