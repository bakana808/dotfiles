...
Singleton {
    ...
    // True if connected to any wifi network
    property bool wifi: true

    // True if connected to any ethernet network
    ...
    // Signal strength of current network (0-100), -1 if unknown
    property int networkStrength: -1
