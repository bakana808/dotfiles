...
return {
    ...
    opts = {
      ...
      completion = {
        menu = {
          draw = {
            treesitter = { 'lsp' },
            columns = { { 'kind_icon', gap = 3 }, { 'label', 'label_description' }, { 'kind' } },
          },
        },
  ...
  { -- Highlight, edit, and navigate code
    ...
    --    - Treesitter + textobjects: https://github.com/nvim-treesitter/nvim-treesitter-textobjects
    {
      ...
      config = function()
        vim.keymap.set('n', '<leader>r', ':lua require("spectre").toggle()<CR>', { desc = 'Toggle Find and [R]replace' })
      end,
    },
  },
  { 'mphe/vim-gdscript4' }, -- GDScript syntax highlighting
  -- ---@type LazySpec
  -- {
